  ...
  <main id="jinyu-content" class="jinyu-content jinyu-single-wrap">
    <?php while (have_posts()): the_post(); ?>
      <article class="jinyu-single">
        ...
        <?php $jy_series = jinyu_get_series_posts(get_the_ID()); ?>
        <?php if ($jy_series): ?>
        ...
        <?php endif; ?>
        <div class="jinyu-article-content" data-jinyu-author="<?php the_author(); ?>" data-jinyu-site="<?php echo esc_attr(get_bloginfo('name')); ?>" data-jinyu-read-min="<?php echo (int)jinyu_read_time(); ?>"><?php the_content(); ?></div>
