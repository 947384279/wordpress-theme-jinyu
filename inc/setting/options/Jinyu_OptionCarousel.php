    ...
    public function get_fields(): array
    {
        return [
            ...
            'fields' => [
                ...
                ['id'=>'home_exclude_cats','title'=>__('最新文章排除分类','jinyu'),'type'=>'category-multi','sdt'=>'','desc'=>__('勾选的分类不会出现在首页主循环（最新文章）中','jinyu')],

                ['id'=>'home_show_four_grid','title'=>(__('显示首页四宫格','jinyu')),'type'=>'switch','sdt'=>false,'desc'=>(__('仅首页第一页显示，位置在幻灯片下方','jinyu'))],
                ['id'=>'home_four_grid_list','title'=>__('首页四宫格列表','jinyu'),'type'=>'dynamic-list','sdt'=>[],'draggable'=>true,'max'=>4,'showRefId'=>'home_show_four_grid','dynamicModel'=>[
                ...
                ['id'=>'home_show_2box','title'=>(__('显示分类两栏','jinyu')),'type'=>'switch','sdt'=>true],
                ['id'=>'home_show_2box_id','title'=>(__('分类两栏·分类','jinyu')),'type'=>'category-multi','sdt'=>'','desc'=>(__('勾选要展示的分类（按分类分两栏）','jinyu'))],
                ['id'=>'home_show_2box_num','title'=>(__('分类两栏·每栏数量','jinyu')),'type'=>'number','sdt'=>6,'min'=>1],
            ],
        ];
    }
}
